        ...
        while (have_posts()) {
            ...
            <div <?php post_class(); ?>>
                <div class="main-post-container">
                    <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>"><img src="<?php echo esc_url(get_avatar_url(get_the_author_meta('user_email'))); ?>" alt="post_avatar"></img></a>
