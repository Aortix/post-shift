...
function wp_custom_nav_menus()
{
    register_nav_menu('pages-menu', __('Pages Menu', 'post-shift'));
    register_nav_menu('categories-menu', __('Categories Menu', 'post-shift'));
}
...
add_action('init', 'wp_custom_nav_menus');
